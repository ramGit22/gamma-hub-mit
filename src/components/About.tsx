          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="md:w-2/3">
              <p className="text-text-medium text-lg leading-relaxed mb-6">
                Inspired by MIT research, 40 Hz gamma frequency stimulation may
                support brain health in Alzheimer's patients by reducing
                amyloid-beta and enhancing cognitive function. Our audio and
                video collection recreates the science behind MIT’s findings,
                like those in the PLOS ONE study on mild AD dementia, for
                curious minds and science enthusiasts. Not a treatment, but a
                window into neuroscience innovation.
              </p>

              <p className="text-text-medium text-lg leading-relaxed mb-6">
                The 40 Hz frequency corresponds to the gamma brainwave band,
                which is associated with higher-order cognitive functions
                including attention, perception, and memory formation.
              </p>
